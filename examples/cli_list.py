...
def cmd_wells(args: argparse.Namespace) -> None:
    client = get_client()
    wells = client.wells.list(region_id=args.region_id)
...
def cmd_projects(args: argparse.Namespace) -> None:
    client = get_client()
    page = client.projects.list(region_id=args.region_id)
...
def cmd_fluid_models(args: argparse.Namespace) -> None:
    client = get_client()
    page = client.fluid_models.list(project_id=args.project_id)
