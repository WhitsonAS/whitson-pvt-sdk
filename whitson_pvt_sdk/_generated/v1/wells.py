...
def list_wells_info(transport: HTTPTransport, region_id: int) -> WellsListModel:
...
def create_well_deprecated(transport: HTTPTransport, data: CreateWellModel) -> GetWellModel:
    body = transport.post("/wells/create", body=data.model_dump(exclude_unset=True))
    return GetWellModel.model_validate(body)
